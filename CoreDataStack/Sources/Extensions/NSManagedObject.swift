...
//                              in context: NSManagedObjectContext) throws -> [Any]? {
//
...
//                               predicate: NSPredicate? = nil, orderedBy sortDescriptors: [NSSortDescriptor]? = nil,
//                               in context: NSManagedObjectContext) throws -> [NSDictionary]? {
//
...
//    }
    ...
    /**
     ...
     - parameter context: If not specified, `AERecord.Context.default` will be used.
     */
//    func refresh(mergeChanges: Bool = true, in context: NSManagedObjectContext) {
...
//                           in context: NSManagedObjectContext) -> NSBatchUpdateResult? {
//
